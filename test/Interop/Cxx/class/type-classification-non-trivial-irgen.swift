...
// CHECK: call void @{{_ZN33StructWithCopyConstructorAndValueC1Ei|"\?\?0StructWithCopyConstructorAndValue@@QEAA@H@Z"}}(%struct.StructWithCopyConstructorAndValue* noalias [[STRUCT]], i32 42)
...
// CHECK: call void @{{_ZN33StructWithCopyConstructorAndValueC1Ei|"\?\?0StructWithCopyConstructorAndValue@@QEAA@H@Z"}}(%struct.StructWithCopyConstructorAndValue* noalias [[MEMBER_STRUCT]], i32 42)
